...
Original file is located at
    https://colab.research.google.com/drive/1kikJm8uMcDJCEL1P0BVSehpS9C5Ux85W
...
# Convert Input:
numbers_list = [int(x) for x in input_numbers.split(" ")]
numbers_tuple = tuple(int(x) for x in input_numbers.split(" "))
...
numbers_list = [int(x) for x in input_numbers.split(" ")]
numbers_tuple = tuple(int(x) for x in input_numbers.split(" "))
numbers_set = {int(x) for x in input_numbers.split(" ")}
numbers_dict = {int(x): int(x) * int(x) for x in input_numbers.split(" ")}
...
list_to_dict = {int(x): int(x) * int(x) for x in numbers_list}
tuple_to_list = list(numbers_tuple)
tuple_to_set = set(numbers_tuple)
tuple_to_dict = {int(x): int(x) * int(x) for x in numbers_tuple}
set_to_list = list(numbers_set)
set_to_tuple = tuple(numbers_set)
set_to_dict = {int(x): int(x) * int(x) for x in numbers_set}
...
print("Total number of numbers:", number_count)
...
with open('output.txt', 'a') as file:
    file.write("\nTotal sum of numbers is added to the file!")
...
if max_number > 1:
    for i in range(2, int(max_number ** 0.5) + 1):
        if max_number % i == 0:
            ...
            break
    if prime_flag == 0:
        print(max_number, "is a prime number")
    else:
        print(max_number, "is not a prime number")
else:
    print(max_number, "is not a prime number")

f = open("prime_numbers.txt", "w")
f.write(
    "Prime numbers: " + str(prime_numbers) + "\n" +
    "Sum of prime numbers: " + str(prime_sum) + "\n" +
    "Smallest prime number: " + str(min_prime) + "\n" +
    "Largest prime number: " + str(max_prime) + "\n")
f.close()
